...
<head>
	...
	<!-- 引入bootstrap -->
	<link rel="stylesheet" type="text/css" href="/ssm/css/bootstrap.min.css">
			...
			<div class="col-md-10">
				<div class="panel panel-default">
				    ...
				    <div class="panel-body">
						<form class="form-horizontal" role="form" action="/ssm/admin/editStudent" id="editfrom" method="post">
